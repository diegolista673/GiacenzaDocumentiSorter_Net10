...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CommessaTipologiaContenitore>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("CommessaTipologiaContenitore");
        ...
        modelBuilder.Entity<SettingsCommesse>(entity =>
        {
            ...
            entity.HasOne(d => d.IdCentroNavigation).WithMany(p => p.SettingsCommesses)
                .HasForeignKey(d => d.IdCentro)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SettingsCommesse_CentriLav");

            entity.HasOne(d => d.IdCommessaNavigation).WithMany(p => p.SettingsCommesses)
                .HasForeignKey(d => d.IdCommessa)
                .OnDelete(DeleteBehavior.ClientSetNull)
