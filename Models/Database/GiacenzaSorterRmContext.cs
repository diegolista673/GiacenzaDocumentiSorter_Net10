...
public partial class GiacenzaSorterRmContext : DbContext
{
    public GiacenzaSorterRmContext()
    {
    }

    public GiacenzaSorterRmContext(DbContextOptions<GiacenzaSorterRmContext> options)
        : base(options)
    {
    }
